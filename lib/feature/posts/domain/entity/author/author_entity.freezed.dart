...
/// @nodoc
@JsonSerializable()
class _$_AuthorEntity extends _AuthorEntity {
  const _$_AuthorEntity({required this.id}) : super._();
...
abstract class _AuthorEntity extends AuthorEntity {
  const factory _AuthorEntity({required final int id}) = _$_AuthorEntity;
  const _AuthorEntity._() : super._();
